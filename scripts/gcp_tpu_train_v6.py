#!/usr/bin/env python3
"""
V6: TPU Training with proper XLA handling
- Uses mark_step() correctly 
- Smaller initial compilation
- Based on working CPU v5
"""
import os
os.environ['TPU_CHIPS_PER_PROCESS_BOUNDS'] = '1,1,1'
os.environ['TPU_PROCESS_BOUNDS'] = '1,1,1'
os.environ['XLA_USE_BF16'] = '0'  # Disable bfloat16 for now
...
print('=== TPU Training V6 (MLP with XLA) ===')

# Import XLA after env setup
import torch_xla.core.xla_model as xm

# Config
BATCH_SIZE = 128  # Smaller for faster XLA compilation
EPOCHS = 10
SEQ_LEN = 32
N_FEATURES = 2
HIDDEN = 64
...
# Warm up XLA compiler with a single pass
print('\nWarming up XLA compiler...')
...
model.train()
warmup_out = model(warmup_x)
warmup_loss = criterion(warmup_out, warmup_y)
...
# Save model
torch.save(model.state_dict(), '/tmp/mlp_v6_model.pt')
print('Model saved to /tmp/mlp_v6_model.pt')
