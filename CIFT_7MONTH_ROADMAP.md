# CIFT Markets: 7-Month Production Roadmap
...
**Tasks**:
- [x] GitHub repository + project structure (github.com/MessoJ/cift-markets)
- [x] Docker Compose (QuestDB, PostgreSQL, Dragonfly, NATS)
...
### Today (2 hours)
1. [x] Read all documentation (this file + others)
2. [x] Set up GitHub repository (github.com/MessoJ/cift-markets)
3. [x] Install Docker Desktop
4. [ ] Register ciftmarkets.com domain
