...
async def get_latest_tick(symbol: str) -> Optional[Dict[str, Any]]:
    """
...
async def get_bid_ask_spread(symbol: str) -> Optional[float]:
    """
...
async def get_open_orders(user_id: UUID, symbol: Optional[str] = None) -> List[Dict[str, Any]]:
    """
...
async def cancel_all_orders_fast(user_id: UUID, symbol: Optional[str] = None) -> int:
    """
...
async def get_performance_analytics(
    ...
    **Tech Stack:**
    ...
    try:
        ...
        logger.info(f"✅ Analytics via ClickHouse + Polars (100x faster)")
...
async def get_pnl_breakdown(
    ...
    **Tech Stack:**
    ...
    try:
        ...
        logger.info(f"✅ P&L breakdown via ClickHouse (100x faster GROUP BY)")
