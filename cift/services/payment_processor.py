...
from cift.services.payment_processors import (
...
class PaymentProcessor:
    ...
    async def create_payment_intent(
        ...
        try:
            ...
            raise RuntimeError(f"Card payment error: {str(e)}")
    ...
    async def create_bank_transfer(
        ...
        try:
            ...
            raise RuntimeError(f"Bank transfer error: {str(e)}")
    ...
    async def process_withdrawal(
        ...
        try:
            ...
            raise RuntimeError(f"Withdrawal error: {str(e)}")
