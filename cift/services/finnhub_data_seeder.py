...
class FinnhubDataSeeder:
    ...
    async def get_earnings_calendar(self, symbol: str) -> Optional[List]:
    ...
    async def get_pattern_recognition(self, symbol: str, resolution: str = "D") -> Optional[Dict]:
        """
    ...
    async def get_support_resistance(self, symbol: str, resolution: str = "D") -> Optional[Dict]:
...
async def main():
    ...
    from cift.core.database import initialize_all_connections, close_all_connections
