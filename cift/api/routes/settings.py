...
from cift.core.auth import get_current_active_user, get_current_user_id, User
...
class UserSettings(BaseModel):
    ...
    quiet_start_time: Optional[str] = "22:00:00"
    quiet_end_time: Optional[str] = "08:00:00"
...
class UserSettingsUpdate(BaseModel):
    ...
    require_order_confirmation: Optional[bool] = None
    enable_fractional_shares: Optional[bool] = None
    email_notifications: Optional[bool] = None
    email_trade_confirms: Optional[bool] = None
    email_market_news: Optional[bool] = None
    email_price_alerts: Optional[bool] = None
    sms_notifications: Optional[bool] = None
    sms_trade_confirms: Optional[bool] = None
    sms_price_alerts: Optional[bool] = None
    push_notifications: Optional[bool] = None
    push_trade_confirms: Optional[bool] = None
    push_market_news: Optional[bool] = None
    push_price_alerts: Optional[bool] = None
    notification_quiet_hours: Optional[bool] = None
    ...
    show_buying_power: Optional[bool] = None
    show_day_pnl: Optional[bool] = None
    ...
    **IMPORTANT:** The full API key is only shown once.
    ...
    try:
        async with pool.acquire() as conn:
            ...
            if not table_exists:
                logger.warning(f"api_keys table does not exist - denying key creation")
                raise HTTPException(
