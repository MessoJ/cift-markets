...
from cift.core.data_processing import load_ohlcv_data, calculate_technical_indicators
...
async def publish_price_update(symbol: str, price: float, bid: Optional[float] = None, ask: Optional[float] = None):
    """
