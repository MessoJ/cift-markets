...
class PolygonL2Connector:
    ...
    def _parse_quote(self, data: Dict[str, Any]) -> Optional[L2Quote]:
    ...
    def _parse_trade(self, data: Dict[str, Any]) -> Optional[Trade]:
    ...
    def _parse_aggregate(self, data: Dict[str, Any]) -> Optional[AggregateBar]:
