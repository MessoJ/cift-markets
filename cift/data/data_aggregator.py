...
class MarketDataAggregator:
    ...
    def __init__(
        ...
        # Data connectors
        self._polygon: Optional[PolygonL2Connector] = None
        self._databento: Optional[DatabentoConnector] = None
    ...
    def get_processor(self, symbol: str) -> Optional[OrderBookProcessor]:
    ...
    def get_latest_bar(self, symbol: str) -> Optional[AggregateBar]:
