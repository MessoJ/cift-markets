...
class L3OrderBook:
    ...
    def get_top_of_book(self) -> Tuple[Optional[BookLevel], Optional[BookLevel]]:
...
class DatabentoConnector:
    ...
    def _parse_mbo_record(self, record: Any) -> Optional[L3Order]:
    ...
    def _parse_trade_record(self, record: Any) -> Optional[TradeRecord]:
    ...
    def get_book(self, symbol: str) -> Optional[L3OrderBook]:
